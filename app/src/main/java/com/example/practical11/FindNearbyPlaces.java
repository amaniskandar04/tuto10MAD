...
public class FindNearbyPlaces extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String type = SPCategory.getSelectedItem().toString().toLowerCase();
    ...
    //gets user location using fusedLocationProviderClient, gets Lat and Long from it and puts marker
